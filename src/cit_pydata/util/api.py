...
def get_environment_variable(logger=None, path_to_env_file=None, variable_name=None):
        ...
        if log_type == "file":
            ...
            if (
                ...
                try:
                    ...
                    retain_value = list(dict(cleanup_policy["retain_last_n"]).values())[
                        0
                    ]
                    retain_unit = list(dict(cleanup_policy["retain_last_n"]).keys())[0]
