...
from util import api as util_api
from aws import api as aws_api
...
class SQLClient:
    def __init__(self, conn, logger=None):
        ...
        if isinstance(logger, logging.Logger):
            ...
            self.logger = util_api.get_logger(__name__, util_api.get_log_level())
    ...
    def _get_sql_engine(self):
        ...
        This method will use the AWS IAM credentials defined in eab-pydata .env file to get the AWS SSM parameters defining SQL authentication details
        """
        try:
        ...
        if self.dialect == "pyodbc":
            ...
            if self.execution_options:
                ...
                sqlalchemy_engine = sqlalchemy.create_engine(
                    engine_connection_string, echo=False
                )
